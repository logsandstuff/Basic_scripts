...
set dst=%~d0\Fall_2019\%COMPUTERNAME%_%date:~-4,4%%date:~-10,2%%date:~7,2%_%time:~-11,2%%time:~-8,2%%time:~-5,2%
mkdir %dst% >>nul
...
REM xcopy /C /Q /G /Y /E %USERPROFILE%\Downloads\*.pdf %dst% >>nul

REM Same as above but does not create empty directories
xcopy /C /Q /G /Y /S %USERPROFILE%\*.pdf %dst% >>nul
